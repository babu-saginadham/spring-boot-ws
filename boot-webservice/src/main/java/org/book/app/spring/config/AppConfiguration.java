package org.book.app.spring.config;
...
@Configuration
@ComponentScan("org.book")
@EnableJpaRepositories(basePackages={"org.book.data"})
...
public class AppConfiguration {
	...
	public DataSource getDataSource(DatabasePopulator databasePopulator) {
		...
		dataSource.setDriverClassName(environment.getProperty("app.driver.classname"));
		dataSource.setUrl(environment.getProperty("app.url"));
		dataSource.setUsername(environment.getProperty("app.jdbc.username"));
		dataSource.setPassword(environment.getProperty("app.jdbc.password"));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
		...
		entityManagerFactoryBean.setPackagesToScan("org.book");
